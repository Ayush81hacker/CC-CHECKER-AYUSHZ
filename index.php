...
<head>
    ...
    <title>[⍋] CC CHECKER BY AYUSHZ</title>
    <!-- CSS -->
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5"><strong>†AYUSHZ</strong></h6>
                    <p class="page-title-description mr-0 d-none d-md-inline-block"></p>
                </div>
                <!-- /.page-title-left -->
                <h1><strong><a href="http://namso-gen.com">CC GEN</a></h1></strong>
                <!-- /.page-title-right -->
            </div>
            <!-- /.page-title -->
            <!-- =================================== -->
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title"> <a href="http://t.me/NinjaBinnerZ">[⍋]𝐍𝐈𝐍𝐉𝐀 𝑩𝑰𝑵𝑵𝑬𝑹𝒁</a> </h5>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <p>Edited By :  <a target="_BLANK" href="https://telegram.me/AyushZ_IZ_Pro">
                                    AyushZ ♛</a></p>
